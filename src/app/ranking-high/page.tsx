...
const Ranking: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-red-900 to-black flex flex-col items-center justify-start p-4 pt-16">
            <div className="fixed top-0 left-0 right-0 bg-red-900 p-4 z-10">
                <button
                    onClick={() => router.push('/')}
            ...
            <h1 className="text-4xl font-bold mb-6 text-red-500 animate-pulse mt-8">高難易度モードランキング</h1>
